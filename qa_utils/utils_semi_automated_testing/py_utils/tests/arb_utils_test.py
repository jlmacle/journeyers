...
arbs_dir_path = Path('./qa_utils/utils_semi_automated_testing/py_utils/tests/arb_utils_test_data')

def test_get_base_locales_file_paths():
    expected = [WindowsPath('./qa_utils/utils_semi_automated_testing/py_utils/tests/arb_utils_test_data/app_en.arb'), WindowsPath('./qa_utils/utils_semi_automated_testing/py_utils/tests/arb_utils_test_data/app_fr.arb')]
...
def test_get_language_code_from_base_locale_file_path():
    expected = 'en'
    assert get_language_code_from_base_locale_file_path(Path('./qa_utils/utils_semi_automated_testing/py_utils/tests/arb_utils_test_data/app_en.arb')) == expected
