...
def main():
    ...
    # Relative file path
    # path on wWndows: "test\common_widgets\interaction_and_inputs\custom_checkbox_list_tile_with_text_field_visual_testing.dart"
    file_path = r"test\common_widgets\interaction_and_inputs\custom_snackbar_start_message_helper_visual_testing.dart"
