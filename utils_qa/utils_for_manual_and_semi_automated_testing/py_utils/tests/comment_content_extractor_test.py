...
def test_first_comment_extraction_with_comment_to_find():
    file_path = "test/custom_widgets/display_and_content/custom_focusable_text_visual_testing.dart"
    delimiter_line = "// Line for automated processing"
    expected = "// flutter run -t ./test/custom_widgets/display_and_content/custom_focusable_text_visual_testing.dart -d chrome"
    # strip() to remove /r /n
