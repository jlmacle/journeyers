...
osascript -e 'tell application "Terminal" to do script "cd /Users/dev/Desktop/journeyers/; flutter run -t ./test/widgets/custom/interaction_and_inputs/custom_checkbox_list_tile_with_text_field_visual_testing.dart -d web-server --web-port 8091"'
osascript -e 'tell application "Terminal" to do script "cd /Users/dev/Desktop/journeyers/; flutter run -t ./test/widgets/custom/interaction_and_inputs/custom_padded_text_field_visual_testing.dart -d web-server --web-port 8092"'
osascript -e 'tell application "Terminal" to do script "cd /Users/dev/Desktop/journeyers/; flutter run -t ./test/widgets/custom/interaction_and_inputs/custom_language_switch_visual_testing.dart -d web-server --web-port 8093"'
osascript -e 'tell application "Terminal" to do script "cd /Users/dev/Desktop/journeyers/; flutter run -t ./test/widgets/custom/interaction_and_inputs/custom_expansion_tile_visual_testing.dart -d web-server --web-port 8094"'
