...
void main() {
  ...
  group("CACheckboxWithSanitizedAndPaddedTextField Tests: \n", () {  
    group("Presence/Absence of the text field: \n", () { 
        testWidgets("At start, the checkbox is unchecked, and the textfield is absent", 
        ...
        testWidgets("If the checkbox is checked, the textfield is present", 
          (WidgetTester tester) async 
          {
            // Pumping the widget 
            await pumpCACheckboxWithSanitizedAndPaddedTextField(tester);
    ...
    group("Text field state maintained: \n", () { 
      testWidgets("Text maintained if text was present, and the checkbox is unchecked/re-checked: \n", 
          (WidgetTester tester) async 
          {
