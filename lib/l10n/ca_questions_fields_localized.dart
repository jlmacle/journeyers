...
class CAQuestionsFieldsLocalized
{
...
// ─── USED IN THE CA FORM ───────────────────────────────────────
  ...
  CAQuestionsFieldsLocalized(BuildContext context)
  {    
    /// Question asked in the form: As an individual: What problem am I trying to solve?
    level2TitleIndividual = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_individual_perspective_title_question)
          ?? "Issue with the title question for the individual perspective";

    /// Question asked in the form: A Balance Issue?
    level3TitleBalanceIssue = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_individual_perspective_balance_issue_section_question) ?? "Issue with the section question for the balance issue, in the individual perspective";
    /// Question asked in the form: To balance studies and household life?
    level3TitleBalanceIssueItem1 = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_individual_perspective_balance_studies_household) ?? "Issue with the studies-household life balance question, in the individual perspective";
    /// Question asked in the form: To balance accessing income and household life?
    level3TitleBalanceIssueItem2 = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_individual_perspective_balance_accessing_income_household) ?? "Issue with the accessing income-household life balance question, in the individual perspective";
    /// Question asked in the form: To balance earning an income and household life?
    level3TitleBalanceIssueItem3 = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_individual_perspective_balance_earning_income_household) ?? "Issue with the earning income-household life balance question, in the individual perspective";
    /// Question asked in the form: To balance helping others and household life?
    level3TitleBalanceIssueItem4 = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_individual_perspective_balance_helping_others_household) ?? "Issue with the helping others-household life balance question, in the individual perspective";

    // Question asked in the form: A Workplace Issue?
    level3TitleWorkplaceIssue = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_individual_perspective_workplace_issue_section_question) ?? "Issue with the section question for the workplace issue, in the individual perspective";
    /// Question asked in the form: To solve a need to be more appreciated at work?
    level3TitleWorkplaceIssueItem1 = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_individual_perspective_workplace_more_appreciated) ?? "Issue with the more-appreciated-at-work question, in the individual perspective";
    /// Question asked in the form: To solve a need to remain appreciated at work?
    level3TitleWorkplaceIssueItem2 = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_individual_perspective_workplace_to_remain_appreciated) ?? "Issue with the to-remain-appreciated-at-work question, in the individual perspective";

    // Heading level 3 and sub items
    /// Question asked in the form: A Legacy Issue?
    level3TitleLegacyIssue = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_individual_perspective_legacy_issue_section_question) ?? "Issue with the section question for the legacy issue, in the individual perspective";
    /// Question asked in the form: To have a better legacy to leave to my children/others?
    level3TitleLegacyIssueItem1 = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_individual_perspective_legacy_better_legacy) ?? "Issue with the better legacy question, in the individual perspective";

    // Heading level 3 without sub items
    /// Question asked in the form: Is The issue Of Another Type?
    level3TitleAnotherIssue = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_individual_perspective_another_issue_section_question) ?? "Issue with the section question for an issue of another type, in the individual perspective";

    // Heading level 2
    /// Question asked in the form: As a member of groups/teams: What problem(s) are we trying to solve?
    level2TitleGroup = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_group_perspective_title_question) ?? "Issue with the title question for the groups/teams perspective";

    // Heading level 3 without sub items
    /// Question asked in the form: What problem(s) are the groups/teams trying to solve?
    level3TitleGroupsProblematics = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_group_perspective_problems) ?? "Issue with the question for the problem(s) the groups/teams are trying to solve";

    // Heading level 3 without sub items
    /// Question asked in the form: Am I trying to solve the same problem(s) as my groups/teams?
    level3TitleSameProblem = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_group_perspective_solving_same_problems) ?? "Issue with the question related to solving the same problem(s) as the groups/teams";

    // Heading level 3 without sub items
    /// Question asked in the form: Is entering the group problem-solving process consistent with harmony at home?
    level3TitleHarmonyAtHome = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_group_perspective_harmony_home) ?? "Issue with the question related to harmony at home";

    // Heading level 3 without sub items
    /// Question asked in the form: Is entering the group problem-solving process consistent with appreciability at work?
    level3TitleAppreciabilityAtWork = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_group_perspective_appreciability_work) ?? "Issue with the question related to the consistency with appreciability at work?";

    // Heading level 3 without sub items
    /// Question asked in the form: Is entering the group problem-solving process consistent with my income earning ability?
    level3TitleIncomeEarningAbility = lineReturnToSpace(AppLocalizations.of(context)?.ca_process_group_perspective_earning_ability) ?? "Issue with the question related to the consistency with earning ability?";
  ...
  List<String> getSanitizedLevel2Titles(BuildContext context) {
    return    
    [
      lineReturnToSpace(_l10n?.ca_process_individual_perspective_title_question)
          ?? "Issue with the title question for the individual perspective",
      lineReturnToSpace(_l10n?.ca_process_group_perspective_title_question)
