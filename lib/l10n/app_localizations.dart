...
abstract class AppLocalizations {
  ...
  /// l10n for the 'Delete data' text
  ///
  /// In en, this message translates to:
  /// **'Delete data'**
  String get dashboard_bulk_delete;

  /// l10n for the 'items' text
  ///
  /// In en, this message translates to:
  /// **'items'**
  String get dashboard_bulk_delete_end_text;
  ...
  /// 'Save failed' SnackBar message, at list saving time.
  ///
  /// In en, this message translates to:
  /// **'Save failed'**
  ...
  /// l10n for the 'List deleted' snackbar message
  ///
  /// In en, this message translates to:
  /// **'List deleted'**
