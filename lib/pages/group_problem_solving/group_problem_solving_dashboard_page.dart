...
/// The page displaying a dashboard of the past group problem-solving sessions.
class GroupProblemSolvingDashboardPage extends StatefulWidget 
{
  /// A callback function called after all session files have been deleted, and used to pass from dashboard to group problem-solving process.
  final VoidCallback parentCallbackFunctionToRefreshTheGroupProblemSolvingPage;

  const GroupProblemSolvingDashboardPage
  ({
    super.key,
    this.parentCallbackFunctionToRefreshTheGroupProblemSolvingPage = placeHolderVoidCallback,
  });

  @override
  State<GroupProblemSolvingDashboardPage> createState() => _GroupProblemSolvingDashboardPageState();
}

class _GroupProblemSolvingDashboardPageState extends State<GroupProblemSolvingDashboardPage> 
{
  ...
  Future<void> _sessionDataRetrieval() async 
  {
    ...
    print("_sessionDataRetrieval: data: $data");
  ...
  Future<void> _deleteSelectedSession(String filePath) async
  {
    ...
    await _du.deleteSessionData(typeOfContextData: DashboardUtils.groupProblemSolvingsContext, filePathRelatedToDataToDelete: filePath);
      ...
      return Scaffold(
        ...
        (
          ...
          (
            ...
            softWrap:true, title, style: groupProblemSolvingPreviewTitleStyle
          ),
        ...
        body: SafeArea(
          ...
          child: SingleChildScrollView(
            ...
            child: Padding(
              ...
              child: GroupProblemSolvingWidget(
                pathToStoredData: filePath,
              ),
            ),
          ),
        ),
